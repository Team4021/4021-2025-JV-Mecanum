...
public final class Constants {
    ...
    // Spark MAX CAN IDs //
    public static final int LEFT_FRONT_DRIVE_MOTOR_ID = 7; // NEO motor
    public static final int RIGHT_FRONT_DRIVE_MOTOR_ID = 8; // NEO motor
    public static final int LEFT_REAR_DRIVE_MOTOR_ID = 6; // NEO motor
    public static final int RIGHT_REAR_DRIVE_MOTOR_ID = 39; // NEO motor
    public static final int INTAKE_BAR_MOTOR_ID = 4; // NEO 550 motor



    public static final int INTAKE_ARM_MOTOR_ID = 16; // NEO motor
    ...
    public static final int END_EFFECTOR_WHEEL_MOTOR_ID = 17; // NEO 550 motor
    public static final int END_EFFECTOR_ARM_MOTOR_ID = 18; // NEO 550 motor
