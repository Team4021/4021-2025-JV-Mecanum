...
public class DriveSubsystem extends SubsystemBase {
	...
	final TalonFX m_leftFrontMotor = new TalonFX(7, "rio"); // NEO motor
	final TalonFX m_rightFrontMotor = new TalonFX(8, "rio"); // NEO motor
	final TalonFX m_leftBackMotor = new TalonFX(6, "rio"); // NEO motor
	final TalonFX m_rightBackMotor = new TalonFX(39, "rio"); // NEO motor
...
public void drive(double moveForward, double strafeRight, double rotate) {
